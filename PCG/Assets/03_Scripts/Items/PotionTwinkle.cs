...
public class PotionTwinkle : MonoBehaviour
{
	...
	private void SineWaveEffect()
	{
		...
		alphaFactor = (sineWave + 1.5f) / 2.0f; //SineWave = -1 to 1 // +1 to go from 0 to 2 // divided by 2 for 0 to 1
